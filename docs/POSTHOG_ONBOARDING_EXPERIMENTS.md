...
### Localization behavior (Phase B)

- Keep `copy_overrides` authored in English in PostHog.
- If app locale is Spanish, iOS sends `copy_overrides` through the backend localization endpoint and renders translated values.
