...
- If app locale is Spanish, Portuguese (Brazil), German, Japanese, or Korean, iOS sends `copy_overrides` through the backend localization endpoint and renders translated values.
